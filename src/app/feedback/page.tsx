...
export default function FeedbackPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Brief delay so the mailto can fire, then show thank-you state
    setTimeout(() => {
      setSubmitting(false);
      setSubmitted(true);
    }, 400);
  ...
  if (submitted) {
    return (
      <div className="max-w-lg mx-auto py-16 space-y-6 text-center">
        <div className="w-16 h-16 mx-auto rounded-2xl bg-emerald-50 border-2 border-emerald-600 flex items-center justify-center text-emerald-700">
        ...
        <div className="flex flex-wrap items-center justify-center gap-3 pt-2">
          <button
            ...
            className="px-5 py-2.5 rounded-xl border-2 border-[#0a192f] text-sm font-bold text-[#0a192f] hover:bg-slate-100 transition"
          >
            Send another
          </button>
          <Link
            href="/"
            className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-[#0a192f] hover:bg-[#132c5b] text-white text-sm font-bold transition border border-[#0a192f]"
            style={{ color: '#ffffff' }}
          >
    ...
    <div className="max-w-lg mx-auto space-y-8">
      <div className="space-y-2">
        <div className="flex items-center gap-3">
          <div className="p-2.5 rounded-2xl bg-slate-100 border-2 border-[#0a192f] text-[#0a192f]">
      ...
      <form
        ...
        className="rounded-3xl bg-white border-2 border-[#0a192f] p-6 sm:p-8 space-y-6 shadow-sm"
      >
        {/* Type */}
              ...
              <label
                ...
                className={`flex items-start gap-3 p-3 rounded-2xl border-2 cursor-pointer transition ${
                  type === opt.value
                    ...
                    : 'border-[#0a192f]/20 hover:border-[#0a192f]/50'
                }`}
              >
                <input
                  type="radio"
        ...
        <div className="space-y-2">
          ...
          <textarea
            ...
            className="w-full px-4 py-3 rounded-2xl bg-white border-2 border-[#0a192f] text-sm text-[#0a192f] placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-[#0a192f]/20 resize-y min-h-[120px]"
          />
        </div>
        ...
        <div className="space-y-2">
          ...
          <input
            ...
            className="w-full px-4 py-2.5 rounded-xl bg-white border-2 border-[#0a192f] text-sm text-[#0a192f] placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-[#0a192f]/20"
          />
        </div>
        ...
        <button
          ...
          className="w-full inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-2xl bg-[#0a192f] hover:bg-[#132c5b] disabled:opacity-50 disabled:cursor-not-allowed text-white font-bold text-sm transition border border-[#0a192f]"
          style={{ color: '#ffffff' }}
        >
