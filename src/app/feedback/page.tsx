  ...
  if (submitted) {
    return (
      <div className="max-w-lg mx-auto py-16 space-y-6 text-center">
        <div className="w-16 h-16 mx-auto rounded-2xl bg-emerald-50 border border-emerald-300 flex items-center justify-center text-emerald-700">
        ...
        <div className="flex flex-wrap items-center justify-center gap-3 pt-2">
          <button
            ...
            className="px-5 py-2.5 rounded-xl border border-black/15 hover:border-black/40 text-sm font-bold text-[#0a192f] hover:bg-slate-100 transition"
          >
            Send another
          </button>
          <Link
    ...
    <div className="max-w-lg mx-auto space-y-8">
      <div className="space-y-2">
        <div className="flex items-center gap-3">
          <div className="p-2.5 rounded-2xl bg-slate-100 border border-black/15 text-[#0a192f]">
      ...
      <form
        ...
        className="rounded-3xl bg-white border border-black/15 hover:border-black/40 p-6 sm:p-8 space-y-6 shadow-sm transition-colors"
      >
        ...
        <div className="space-y-2">
          ...
          <textarea
            ...
            className="w-full px-4 py-3 rounded-2xl bg-white border border-black/15 hover:border-black/40 focus:border-black/50 text-sm text-[#0a192f] placeholder-slate-400 focus:outline-none transition-colors resize-y min-h-[120px]"
          />
        </div>
        ...
        <div className="space-y-2">
          ...
          <input
            ...
            className="w-full px-4 py-2.5 rounded-xl bg-white border border-black/15 hover:border-black/40 focus:border-black/50 text-sm text-[#0a192f] placeholder-slate-400 focus:outline-none transition-colors"
          />
        </div>
